            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    @endif
                        <div class="x_panel">
                            <div class="x_content">
                                {!! Form::open(['method' => 'POST','action' => 'secController@store','class' => 'form-horizontal form-label-left']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        {{ Form::select('day1' , ["0"=>""]+$statut ,null, ['class' => 'form-control','id' => 'status_select']) }}
